...
bool HMC::AES_Unit[32] = {false, false, false, false, false, false, false, false,
                            false, false, false, false, false, false, false, false,
                            false, false, false, false, false, false, false, false,
                            false, false, false, false, false, false, false, false
                            };
int HMC::Just_Reset = 0;
long HMC::Was_Reset_Held_By = -1;
long HMC::Holding = -1;
...
void HMC::init_prereq()
{
    ...
    prereq[int(Level::Bank)][int(Command::RD)] = [] (DRAM<HMC>* node, Command cmd, int id) {
     ...
     /*
    //Encrypt Single Cache line    
    prereq[int(Level::Vault)][int(Command::ES)] = [] (DRAM<HMC>* node, Command cmd, int id) {
        switch (int(node->state)) {
            case int(State::PowerUp): return Command::MAX;
            case int(State::ActPowerDown): return Command::PDX;
            case int(State::PrePowerDown): return Command::PDX;
    ...
    prereq[int(Level::Bank)][int(Command::ES)] = [] (DRAM<HMC>* node, Command cmd, int id) {
            switch (int(node->state)) {
                case int(State::Closed): return Command::ACT;
                case int(State::Opened):
                    if (node->row_state.find(id) != node->row_state.end()){
        ...
        //NW
    prereq[int(Level::Vault)][int(Command::NW)] = [] (DRAM<HMC>* node, Command cmd, int id) {
        switch (int(node->state)) {
            case int(State::PowerUp): return Command::MAX;
            case int(State::ActPowerDown): return Command::PDX;
            case int(State::PrePowerDown): return Command::PDX;
    ...
    prereq[int(Level::Bank)][int(Command::NW)] = [] (DRAM<HMC>* node, Command cmd, int id) {
        switch (int(node->state)) {
            case int(State::Closed): return Command::ACT;
            case int(State::Opened):
                if (node->row_state.find(id) != node->row_state.end())
...
void HMC::init_rowhit()
{
    ...
    //ES
    rowhit[int(Level::Bank)][int(Command::ES)] = rowhit[int(Level::Bank)][int(Command::RD)];
    
    //NW
    rowhit[int(Level::Bank)][int(Command::NW)] = rowhit[int(Level::Bank)][int(Command::RD)];
...
void HMC::init_rowopen()
{
    ...
    //ES
    rowopen[int(Level::Bank)][int(Command::ES)] = rowopen[int(Level::Bank)][int(Command::RD)];
    
    //NW
    rowopen[int(Level::Bank)][int(Command::NW)] = rowopen[int(Level::Bank)][int(Command::RD)];
}
...
void HMC::init_lambda()
{
    ...
    lambda[int(Level::Bank)][int(Command::ES)] = [] (DRAM<HMC>* node, int id) {};
    lambda[int(Level::Bank)][int(Command::NW)] = [] (DRAM<HMC>* node, int id) {};
