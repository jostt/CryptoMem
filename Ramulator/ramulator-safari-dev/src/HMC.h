...
public:
    ...
    static bool AES_Unit[32];
    static int Just_Reset;
    static long Was_Reset_Held_By;
    static long Holding;
    ...
    Level scope[int(Command::MAX)] = {
        ...
        Level::Vault,   Level::Vault,   Level::Vault,   Level::Vault,   Level::Vault, Level::Column, Level::Column, Level::Column
    };
    ...
    Command translate[int(Request::Type::MAX)] = {
        ...
        Command::REF, Command::PDE, Command::SRE, Command::PH, Command::ES, Command::NW
    };
